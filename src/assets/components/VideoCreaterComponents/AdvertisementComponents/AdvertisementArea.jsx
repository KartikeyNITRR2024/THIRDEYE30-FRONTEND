...
import AdvertisementGroupArea from "./AdvertisementGroupArea";
import ContentAdvertisementArea from "./ContentAdvertisementArea";

export default function AdvertisementArea({ onBack }) {
  ...
  const stockpageItems = [
    {
      id: 101,
      name: "Advertisement Group",
      icon: <FaLayerGroup className="text-4xl" />,
    },
    {
      id: 102,
      name: "Content Advertisement",
      icon: <MdOutlineContentPaste className="text-4xl" />,
    },
  ];
          ...
          <>
            <div className="flex justify-between items-center mb-6">
              ...
              <div className="text-right">
                <h2 className="text-sm font-black text-gray-700 uppercase">Advertisement Assets</h2>
