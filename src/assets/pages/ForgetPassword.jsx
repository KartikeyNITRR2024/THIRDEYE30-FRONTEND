      ...
      <AnimatePresence mode="wait">
        ...
        >
          ...
          <form
            ...
            className="md:p-20 md:border md:border-gray-600 md:backdrop-blur-sm"
          >
            ...
            <input
              className="m-2 text-black bg-white -mx-1 p-3 w-full border border-black rounded-xl placeholder-gray-600"
              type="text"
